    ...
    <div class="relative w-full max-w-xl glass-panel p-10 flex flex-col items-center">
        ...
        <div class="w-full space-y-4">
            ...
            <button onclick="window.open('https://stonebattlevs.pages.dev/', '_blank')" class="group relative w-full h-24 glass-panel hover:bg-white/5 overflow-hidden transition-all duration-300 active:scale-[0.98] flex items-center px-8 border-l-4 border-l-transparent hover:border-l-primary">
                ...
                <div class="text-left flex-1">
                    <h3 class="font-headline font-bold text-lg text-white group-hover:text-primary transition-colors uppercase tracking-tight">Stone Battle</h3>
                    <p class="text-[10px] text-slate-500 uppercase tracking-widest font-medium"> 공격조와 방어조로 나뉘어 타자로 경쟁하세요.</p>
                </div>
                <div class="opacity-0 group-hover:opacity-100 transition-opacity">
                    <span class="material-symbols-outlined text-primary">chevron_right</span>
                </div>
